...
(function($) {
	function TouchCarousel(element, options) {	
		...
		itemsJQ.each(function(index) {
			...
			//Sunlime IT Services: Fix on reload (Webkit browsers)
			if (itemObj.width < 660)
			{
				itemObj.width = 660;
			}
	...
	$.fn.touchCarousel.defaults = {  
			...
			itemFallbackWidth: 660,       // Default width of the item in pixels. (used if impossible to get item width).
