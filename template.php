...
function gemeinde_gabersdorf_form_alter(&$form, &$form_state, $form_id) {
  if ($form_id == 'search_block_form') {
    ...
    $form['actions']['submit']['#value'] = t('Suche'); // Change the text on the submit button
    $form['actions']['submit'] = array('#type' => 'image_button', '#src' => base_path() . path_to_theme() . '/images/search-button.png');
    $form['actions']['submit']['#attributes']['alt'] = t('Suche');
...
function gemeinde_gabersdorf_preprocess_maintenance_page(&$variables, $hook) {
  // When a variable is manipulated or added in preprocess_html or
  // preprocess_page, that same work is probably needed for the maintenance page
  // as well, so we can just re-use those functions to do that work here.
  gemeinde_gabersdorf_preprocess_html($variables, $hook);
  gemeinde_gabersdorf_preprocess_page($variables, $hook);
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function gemeinde_gabersdorf_preprocess_html(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function gemeinde_gabersdorf_preprocess_page(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function gemeinde_gabersdorf_preprocess_node(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');

  // Optionally, run node-type-specific preprocess functions, like
  // gemeinde_gabersdorf_preprocess_node_page() or gemeinde_gabersdorf_preprocess_node_story().
 ...
 */
/* -- Delete this line if you want to use this function
function gemeinde_gabersdorf_preprocess_comment(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function gemeinde_gabersdorf_preprocess_region(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function gemeinde_gabersdorf_preprocess_block(&$variables, $hook) {
